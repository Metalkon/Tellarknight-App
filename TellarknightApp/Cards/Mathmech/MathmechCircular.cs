...
namespace TellarknightApp.Cards
{
    public class MathmechCircular : Card
    {
        ...
        public override LocalStats AnalyzeHand(LocalStats localStats, List<Card> hand, List<Card> deck, List<Card> gy, List<Card> extraDeck)
        {
            ...
            if ((hand.Any(x => x.Level == 4 && (x.Archetype.Contains("Tellarknight") || x.Archetype.Contains("Constellar"))) || (hand.Any(x => x is StellarnovaBinding) 
            ...
            if ((hand.Any(x => x.Level == 4 && (x.Archetype.Contains("Tellarknight") || x.Archetype.Contains("Constellar"))) || (hand.Any(x => x is StellarnovaBinding) && deck.Any(x => x.Archetype.Contains("Tellarknight") || x.Archetype.Contains("Constellar")))) 
