...
{
    public class TellarknightCygnian : Card
    {
        public TellarknightCygnian()
        {
            Name = "Constellar Cygnian";
            Type = "Warrior";
            Attribute = "Light";
            Level = 4;
            Attack = 1500;
        ...
        public override LocalStats AnalyzeHand(LocalStats localStats, List<Card> hand, List<Card> deck, List<Card> gy, List<Card> extraDeck)
        {
            ...
            if (deck.Any(x => x.Archetype.Contains("Zefra") && x.Archetype.Contains("Tellarknight")))
            {
            ...
            // Cygnian + Deck Summon
            if (deck.Any(x => x is ConstellarCaduceus))
            {
                localStats.AverageXyzTwoTellar = true;
            }
