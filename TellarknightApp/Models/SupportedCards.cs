    ...
    internal class SupportedCards
    {
        ...
        public SupportedCards()
        {
            Cards = new List<Card>()
            {
                ...
                new Card() { Name = "Living Fossil", Type = "Spell", Level = null, Archetype = "None", Image = "./CardArt/Fossil.png", Role = "" },
                new Card() { Name = "\"Infernoble Arms - Durendal\"", Type = "Spell", Level = null, Archetype = "None", Image = "./CardArt/Durendal.png", Role = "Search" },
                new Card() { Name = "Infernoble Knight - Renaud", Type = "Warrior", Level = 1, Archetype = "None", Image = "./CardArt/Renaud.png", Role = "Extender" },
                new Card() { Name = "Fire Flint Lady", Type = "Warrior", Level = 1, Archetype = "None", Image = "./CardArt/FireFlint.png", Role = "Extender" },

                new Card() { Name = "Sakitama", Type = "Fairy", Level = 4, Archetype = "None", Image = "./CardArt/Sakitama.png", Role = "Extender" },
                new Card() { Name = "ZS - Ascended Sage", Type = "Warrior", Level = 4, Archetype = "None", Image = "./CardArt/AscendedSage.png", Role = "Extender" },
                new Card() { Name = "Photon Thrasher", Type = "Warrior", Level = 4, Archetype = "None", Image = "./CardArt/Thrasher.png", Role = "Extender" },
                new Card() { Name = "Reinforcement of the Army", Type = "Spell", Level = null, Archetype = "None", Image = "./CardArt/Rota.png", Role = "Search" },
                new Card() { Name = "Terraforming", Type = "Spell", Level = null, Archetype = "None", Image = "./CardArt/Terraforming.png", Role = "Search" },
                ...
                new Card() { Name = "Level 4", Type = "", Level = 4, Archetype = "None", Image = "./CardArt/CelticGuardian.png", Role = "" },
                new Card() { Name = "Hand Trap", Type = "", Level = null, Archetype = "None", Image = "./CardArt/HandTrap.png", Role = "HandTrap" },
                new Card() { Name = "Empty Card", Type = "", Level = null, Archetype = "None", Image = "./CardArt/CardBack.png", Role = "" },
